          ...
          <form className={classes.adminForm0} onSubmit={handleSubmit}>
            <div className={classes.adminForm1}>
              <div className={classes.adminForm2l}>
                ...
                <div className={classes.adminForm3}>
                  <h1 className={classes.adminLabel}>Credit:</h1>
                  ...
                  <input
                    ...
                    value={value.credit}
                    onChange={(e) =>
                      setValue({ ...value, credit: e.target.value })
                    }
                  />
                </div>

                <div className={classes.adminForm3}>
                  <h1 className={classes.adminLabel}>Credit Hour:</h1>
                  ...
                  <input
                    ...
                    className={classes.adminInput}
                    type="text"
                    value={value.creditHour}
                    onChange={(e) =>
                      setValue({ ...value, creditHour: e.target.value })
                    }
                  />
                </div>
              </div>
              <div className={classes.adminForm2r}>
                ...
                <div className={classes.adminForm3}>
                  <h1 className={classes.adminLabel}>Term :</h1>
                  <Select
                    required
                    displayEmpty
                    sx={{ height: 36 }}
                    ...
                    value={value.term}
                    onChange={(e) =>
                      setValue({ ...value, term: e.target.value })
                    }
                  >
                    <MenuItem value="">None</MenuItem>
                    <MenuItem value="1">1</MenuItem>
