...
const API = axios.create({ baseURL: "https://nstu-result-server-g51ilrof1-ibrahimecste.vercel.app/" });
...
export const adminRegister = (admin) => API.post("/api/admin/register", admin);
